/**
 * Rhyhorn PDF template - Single-column, ATS-optimized.
...
export function RhyhornPDF({ content, themeSettings }: PDFTemplateProps) {
          ...
          <View style={styles.headerWithPhoto}>
            ...
            <View style={styles.headerContent}>
              ...
              <View style={styles.linksRow}>
                ...
                {content.portfolioUrl && <Link src={content.portfolioUrl} style={styles.link}>Website</Link>}
