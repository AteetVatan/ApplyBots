 ...
 *
 * Clean minimalist single-column design with professional layout.
 * ATS Score: 95
 */
...
export function Rhyhorn({
  ...
  return (
    ...
    >
      {/* Header */}
      <header className={`mb-4 pb-3 border-b border-gray-300 ${highlight("contact")}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="text-gray-700 space-y-0.5" style={{ fontSize: "var(--font-body)" }}>
          ...
          if (sectionKey === "summary" && content.professionalSummary) {
            return (
              <section key={sectionKey} className={`mb-3 ${highlight("summary")}`}>
                <h2 className="font-bold text-gray-900 uppercase tracking-wide mb-1" style={{ fontSize: "var(--font-header)" }}>
          ...
          if (sectionKey === "experience" && content.workExperience.length > 0) {
            return (
              <section key={sectionKey} className={`mb-3 ${highlight("experience")}`}>
                <h2 className="font-bold text-gray-900 uppercase tracking-wide mb-2" style={{ fontSize: "var(--font-header)" }}>
                  Experience
                </h2>
