 ...
 *
 * Clean, minimalist single-column design with profile picture left of name.
 * ATS Score: 95
 */
      ...
      <header className={`mb-4 pb-3 border-b border-gray-300 ${highlight("contact")}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div
              className="text-gray-700 space-y-0.5"
        ...
        if (sectionKey === "experience" && content.workExperience.length > 0) {
          return (
            <section key={sectionKey} className={`mb-3 ${highlight("experience")}`}>
              <h2
                className="font-bold text-gray-900 uppercase tracking-wide mb-2"
                style={{ fontSize: "var(--font-header)" }}
              >
                Experience
              </h2>
              {content.workExperience.map((exp) => (
                <div key={exp.id} className="mb-2.5">
                  ...
                  {exp.achievements.length > 0 && (
                    <ul
                      className="mt-1 pl-4 text-gray-700 list-disc"
                      style={{ fontSize: "var(--font-body)" }}
                    >
            ...
            <React.Fragment key={sectionKey}>
              {content.customSections.map((section) => (
                <section key={section.id} className={`mb-3 ${highlight("custom")}`}>
                  ...
                  <ul
                    className="pl-4 text-gray-700 list-disc"
                    style={{ fontSize: "var(--font-body)" }}
                  >
