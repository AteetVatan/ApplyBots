...
type Phase = "select-resume" | "analyzing" | "questionnaire" | "generating" | "results";
...
export default function ExpertApplyPage() {
    ...
    const [phase, setPhase] = useState<Phase>("select-resume");
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="glass-card p-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h1 className="text-2xl font-display font-bold">Expert Apply</h1>
                            <p className="text-neutral-400">AI-powered resume tailoring for this job</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                        <h3 className="text-sm font-medium text-neutral-300">Select a resume to tailor</h3>
                        {resumesLoading ? (
            ...
            <div className="max-w-2xl mx-auto">
                <div className="glass-card p-12 text-center">
                    ...
                    <p className="text-neutral-400">
                        Comparing your resume against job description...
                    </p>
                </div>
            </div>
        );
        ...
        return (
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    {/* Gap Details */}
                    <div className="glass-card p-6">
                        <h3 className="font-medium mb-3">Requirements Breakdown</h3>
                        <div className="space-y-2">
                            {analysisResult.gap_map.map((item, idx) => (
                                <div
                                    key={idx}
                                    className="flex items-center justify-between p-3 bg-neutral-800/50 rounded-lg"
                                >
                                    <span className="text-sm">{item.requirement_name}</span>
                    ...
                    {analysisResult.questionnaire.length > 0 && (
                        <div className="glass-card p-6">
                            ...
                            <p className="text-sm text-neutral-400 mb-4">
                                Answer these to strengthen your tailored resume.
                            </p>
        ...
        return (
            <div className="max-w-2xl mx-auto">
                <div className="glass-card p-12 text-center">
                    ...
                    <p className="text-neutral-400">
                        Creating your optimized resume and interview prep...
                    </p>
                </div>
            </div>
        );
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="glass-card p-6 text-center bg-gradient-to-br from-primary-950/30 to-purple-950/30">
                        ...
                        <h1 className="text-2xl font-display font-bold mb-1">Your Tailored Resume is Ready</h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="glass-card p-6">
                            <h3 className="font-semibold mb-3">Highlighted Skills</h3>
                            <div className="flex flex-wrap gap-2">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Link
                            ...
                            className="flex-1 py-3 bg-primary-600 hover:bg-primary-500 rounded-xl font-medium transition-colors text-center"
                        >
                            View Applications
                        </Link>
                    </div>
